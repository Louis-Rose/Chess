                    ...
                    >
                      ...
                      {STOCK_GICS_MAP[ticker] && (
                        <button
                          ...
                          className="px-2 py-1 text-xs font-semibold text-purple-100 bg-purple-700 hover:bg-purple-600 rounded-md shadow-sm transition-colors"
                        >
                ...
                >
                  ...
                  {STOCK_GICS_MAP[stock.ticker] && (
                    <button
                      ...
                      className="px-2 py-1 text-xs font-semibold text-purple-100 bg-purple-700 hover:bg-purple-600 rounded-md shadow-sm transition-colors flex-shrink-0"
                    >
