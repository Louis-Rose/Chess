    ...
    <div className={hideContainer ? className : `bg-slate-50 dark:bg-slate-700 rounded-xl p-6 shadow-sm dark:shadow-none ${className}`}>
      ...
      <div className="mb-3">
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">US</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Europe</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Swiss</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Canada</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Australia</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Japan</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
            ...
            className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-500"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">Hong Kong</span>
        </label>
        <label className="flex items-center gap-1.5 cursor-pointer">
          <input
            type="checkbox"
                    ...
                    >
                      ...
                      {STOCK_GICS_MAP[ticker] && (
                        <button
                          ...
                          className="px-2 py-1 text-xs font-semibold text-purple-200 bg-purple-950 hover:bg-purple-900 rounded-md shadow-sm transition-colors"
                        >
                ...
                >
                  ...
                  {STOCK_GICS_MAP[stock.ticker] && (
                    <button
                      ...
                      className="px-2 py-1 text-xs font-semibold text-purple-200 bg-purple-950 hover:bg-purple-900 rounded-md shadow-sm transition-colors flex-shrink-0"
                    >
