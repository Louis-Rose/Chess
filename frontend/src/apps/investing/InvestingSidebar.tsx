...
import { Loader2, Home, Briefcase, Eye, Calendar, TrendingUp, Shield, PanelLeftClose, PanelLeftOpen, Clock, X, Youtube } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/investing/news', icon: Youtube, labelEn: 'News Feed', labelFr: 'Fil d\'actualités' },
