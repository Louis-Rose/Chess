...
import { Loader2, Home, SquareArrowOutUpRight, Eye, Calendar, TrendingUp, Shield, Clock, X, GitCompare, Newspaper } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/investing/portfolio', icon: SquareArrowOutUpRight, labelEn: 'My Portfolio', labelFr: 'Mon Portefeuille' },
