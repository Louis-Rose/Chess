            ...
            {recentStocks.map((ticker) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs font-medium text-slate-200 truncate flex-1 min-w-0">{displayName}</span>
                  <span className="text-xs font-medium text-slate-400 flex-shrink-0">({ticker})</span>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
