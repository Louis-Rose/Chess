...
const TICKER_TO_IR: Record<string, string> = {
  ...
  // ============================================
  // Notable European Small & Mid Caps
  // ============================================
  ...
  BNR: 'https://corporate.brenntag.com/en/investor-relations/',
  GBF: 'https://www.bilfinger.com/en/investor-relations/',
  GFT: 'https://www.gft.com/int/en/about-us/investor-relations',
  GXI: 'https://www.gerresheimer.com/en/company/investor-relations',
  HAG: 'https://www.hensoldt.net/investors/',
  JEN: 'https://www.jenoptik.com/investors',
  JUN3: 'https://www.jungheinrich.com/en/investor-relations',
  KGX: 'https://www.kion-group.com/en/investors/',
  KWS: 'https://www.kws.com/corp/en/investor-relations/',
  LXS: 'https://lanxess.com/en/Investors',
  MLP: 'https://mlp-se.com/investors/',
  MOR: 'https://www.morphosys.com/investors',
  PNE3: 'https://www.pne-ag.com/en/investor-relations/',
  RHM: 'https://www.rheinmetall.com/en/investor-relations',
  SRT3: 'https://www.sartorius.com/en/company/investor-relations',
  SZU: 'https://www.suedzucker.de/en/investor-relations',
  WAC: 'https://www.wacker.com/cms/en-de/about-wacker/investor-relations/investor-relations.html',

  // French Small/Mid Caps
  BIM: 'https://www.biomerieux.com/en/investors',
  CGG: 'https://www.cgg.com/investors',
  CNP: 'https://www.cnp.fr/en/cnp-assurances/investors',
  COFA: 'https://www.coface.com/Investors',
  DBV: 'https://www.dbv-technologies.com/investors/',
  ELIOR: 'https://www.eliorgroup.com/investors',
  FNAC: 'https://www.fnacdarty.com/en/investors/',
  GTT: 'https://gtt.fr/investors',
  ICAD: 'https://www.icade.fr/en/finance',
  SEB: 'https://www.groupeseb.com/en/investors',
  SII: 'https://sii-group.com/en/investors',
  SOI: 'https://www.soitec.com/en/investors/',
  STEF: 'https://www.stef.com/en/investors/',
  TFF: 'https://www.tfrgroup.com/en/investors/',
  UBI: 'https://www.ubisoft.com/en-us/company/investor-relations',
  VLA: 'https://www.vfratsoc.com/en/investors',
  WLN: 'https://investors.worldline.com',

  // Italian Small/Mid Caps
  AZM: 'https://www.azimut-group.com/en/investor-relations',
  BGN: 'https://www.bancagenerali.com/en/investor-relations',
  BMED: 'https://www.bancamediolanum.it/corp/investor-relations',
  BZU: 'https://www.buzzi.com/en/investors',
  CPR: 'https://www.camparigroup.com/en/page/investors',
  DLG: 'https://www.delonghigroup.com/en/investors',
  ERG: 'https://www.erg.eu/en/investors',
  GVS: 'https://www.gvs.com/en/investor-relations/',
  IGD: 'https://www.gruppoigd.it/en/investor-relations/',
  INW: 'https://www.inwit.it/en/investors/',
  IVG: 'https://www.ivecogroup.com/investors',
  OVS: 'https://www.ovscorporate.it/en/investors/',
  PIA: 'https://www.piaggiogroup.com/en/investors',
  REC: 'https://www.recordati.com/investors',
  TOD: 'https://www.todsgroup.com/en/investors/',

  // Spanish Small/Mid Caps
  A3M: 'https://www.atresmedia.com/shareholders-and-investors/',
  ACX: 'https://www.acerinox.com/en/shareholders-and-investors/',
  CAF: 'https://www.caf.net/en/accionistas-inversores/',
  CIE: 'https://www.cieautomotive.com/web/cie-automotive/investors',
  CLNX: 'https://www.cellnex.com/investor-relations/',
  EBRO: 'https://www.ebrofoods.es/en/shareholders-and-investors/',
  FCC: 'https://www.fcc.es/en/shareholders-investors',
  GCO: 'https://www.grupocatalanaoccidente.com/en/shareholders-investors/',
  IAG: 'https://www.iairgroup.com/investors',
  IDR: 'https://www.indracompany.com/en/indra/shareholders-investors',
  LOG: 'https://www.logista.com/en/shareholders-and-investors.html',
  MTS: 'https://www.arcelormittal.com/investors',
  NHH: 'https://www.nh-hotels.com/corporate/en/investors',
  REE: 'https://www.ree.es/en/shareholders-and-investors',
  VIS: 'https://www.viscofan.com/en/shareholders-and-investors/',

  // Dutch Small/Mid Caps
  AALB: 'https://aalberts.com/investors',
  ALFEN: 'https://alfen.com/en/investors',
  ARCAD: 'https://www.arcadis.com/en/investors',
  BESI: 'https://www.besi.com/investor-relations/',
  FLOW: 'https://flowtraders.com/investors',
  FUR: 'https://www.fugro.com/investors',
  IMCD: 'https://www.imcdgroup.com/en/investors',
  JDEP: 'https://www.jdepeets.com/investors/',
  OCI: 'https://www.oci-global.com/investors/',
  TKWY: 'https://www.justeattakeaway.com/investors/',
  URW: 'https://www.urw.com/en/investors',

  // Belgian Small/Mid Caps
  ARGX: 'https://www.argenx.com/investors',
  'BPOST': 'https://www.bpost.be/en/investors',
  COLR: 'https://www.colruytgroup.com/en/investors',
  GLPG: 'https://www.glpg.com/investors',
  SOFINA: 'https://www.sofina.be/en/investors/',
  TNET: 'https://corporate.telenet.be/en/investors',
  VGP: 'https://www.vgpparks.eu/en/investors/',
  WDP: 'https://www.wdp.eu/investors',
  XIOR: 'https://www.xior.be/en/investors',

  // Danish Small/Mid Caps
  'ALK-B': 'https://ir.alk.net/',
  'AMBU-B': 'https://www.ambu.com/investors',
  DANSKE: 'https://danskebank.com/investor-relations/',
  DEMANT: 'https://www.demant.com/investors',
  DFDS: 'https://www.dfds.com/en/about/investors',
  GMAB: 'https://ir.genmab.com',
  NKT: 'https://www.nkt.com/investors',
  'ROCK-B': 'https://www.rockwool.com/group/about-us/investor-relations/',
  TRYG: 'https://tryg.com/en/investors',
  'NZYM-B': 'https://investors.novozymes.com/',

  // Swedish Small/Mid Caps
  AAK: 'https://www.aak.com/investors/',
  AFRY: 'https://afry.com/en/investors',
  'ASSA-B': 'https://www.assaabloy.com/group/en/investors',
  'ESSITY-B': 'https://www.essity.com/investors/',
  'HEXA-B': 'https://investors.hexagon.com/',
  'HUSQ-B': 'https://www.husqvarnagroup.com/en/investors',
  INTRUM: 'https://www.intrum.com/investors/',
  'NIBE-B': 'https://www.nibe.com/investors',
  'SAAB-B': 'https://www.saab.com/investors',
  SINCH: 'https://investors.sinch.com/',
  'SKF-B': 'https://investors.skf.com/',
  'SSAB-B': 'https://www.ssab.com/en/company/investors',
  THULE: 'https://www.thulegroup.com/en/investors',
  MIPS: 'https://ir.mipsprotection.com/',
  'TEL2-B': 'https://www.tele2.com/investors/',

  // Norwegian Small/Mid Caps
  AKERBP: 'https://akerbp.com/en/investors',
  ATEA: 'https://www.atea.com/investors/',
  BAKKA: 'https://www.bakkafrost.com/en/investor-relations/',
  ENTRA: 'https://www.entra.no/en/investor-relations',
  FRO: 'https://www.frontline.bm/investors/',
  NEL: 'https://nelhydrogen.com/investors/',
  PGS: 'https://www.pgs.com/investors/',
  SCATC: 'https://scatec.com/investors/',
  SUBC: 'https://www.subsea7.com/en/investors.html',
  TGS: 'https://www.tgs.com/investors',
  SALM: 'https://www.salmar.no/en/investor/',
  KID: 'https://www.kid.no/investor-relations',

  // Finnish Small/Mid Caps
  AKTIA: 'https://www.aktia.com/en/investors',
  ELISA: 'https://elisa.com/corporate/investors/',
  HARVIA: 'https://harviagroup.com/investors/',
  KAMUX: 'https://www.kamux.com/investors/',
  METSO: 'https://www.metso.com/investors/',
  MUSTI: 'https://company.mustigroup.com/investors/',
  'QT1V': 'https://investors.qt.io/',
  REMEDY: 'https://investors.remedygames.com/',
  SAMPO: 'https://www.sampo.com/investors',
  SANOMA: 'https://www.sanoma.com/en/investors/',
  VALMT: 'https://www.valmet.com/investors/',
  YIT: 'https://www.yitgroup.com/en/investors',

  // Portuguese Small/Mid Caps
  ALTRI: 'https://www.altri.pt/en/investors/',
  BCP: 'https://ind.millenniumbcp.pt/en/Institucional/investidores/',
  CTT: 'https://www.ctt.pt/grupo-ctt/investidores',
  NOS: 'https://www.nos.pt/institucional/EN/investors/',

  // Austrian Small/Mid Caps
  AMS: 'https://ams-osram.com/investors',
  ANDR: 'https://www.andritz.com/group-en/investors',
  BAWAG: 'https://www.bawaggroup.com/IR',
  EVN: 'https://www.evn.at/en/investors',
  POST: 'https://www.post.at/en/ir/investor-relations',
  RBI: 'https://www.rbinternational.com/en/investors.html',
  VIG: 'https://www.vig.com/en/investor-relations.html',

  // UK Small/Mid Caps
  'ASHM': 'https://www.ashmoregroup.com/investors',
  BRBY: 'https://www.burberryplc.com/investors',
  DPLM: 'https://www.diplomaplc.com/investors/',
  FLTR: 'https://www.flutter.com/investors',
  GAW: 'https://investor.games-workshop.com/',
  GRG: 'https://corporate.greggs.co.uk/investors',
  HLMA: 'https://www.halma.com/investors',
  'JET2': 'https://www.jet2plc.com/investors/',
  NXT: 'https://www.nextplc.co.uk/investors',
  OCDO: 'https://www.ocadogroup.com/investors/',
  RMV: 'https://plc.rightmove.co.uk/investors/',
  SBRY: 'https://www.about.sainsburys.co.uk/investors',
  SKG: 'https://www.smurfitkappa.com/investors',
  TSCO: 'https://www.tescoplc.com/investors',
  WEIR: 'https://www.global.weir/investors',
};
