...
import { Briefcase, Eye, TrendingUp, Loader2 } from 'lucide-react';
  ...
  if (!isAuthenticated) {
    return (
      <div className="flex flex-col items-center min-h-[70vh]">
        <h1 className="text-5xl font-bold text-slate-100 mt-16">Track Your Investments</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 transition-colors opacity-60 text-left">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-lg font-bold text-slate-100">Analytics</h3>
              <span className="text-xs bg-slate-700 text-slate-400 px-2 py-0.5 rounded">Coming Soon</span>
            </div>
            <p className="text-slate-400 text-sm">
              Advanced analytics, sector analysis, and AI-powered investment recommendations.
            </p>
          </div>
        </div>
      </div>
