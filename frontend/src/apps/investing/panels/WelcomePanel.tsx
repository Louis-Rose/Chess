        ...
        {isAuthenticated && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-[10%] mb-8">
            ...
            <div
              ...
              className="bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl p-5 cursor-pointer hover:border-amber-500 transition-colors h-[200px] flex flex-col"
            >
              <div className="flex items-center justify-between mb-3 flex-shrink-0">
                <div className="flex items-center gap-2">
                ...
                <div className="flex rounded border border-slate-300 dark:border-slate-600">
                  <div className="relative group">
                    ...
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 px-2 py-1 bg-slate-600 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-75 z-50 w-max max-w-36 text-center pointer-events-none">
