// Earnings Calendar panel - displays upcoming earnings dates for portfolio holdings
...
const fetchEarningsCalendar = async (): Promise<EarningsResponse> => {
  const response = await axios.get('/api/investing/earnings-calendar');
      ...
      <div className="sticky top-0 z-20 bg-slate-800 py-4 -mx-4 px-4 mt-8">
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-slate-400 text-lg italic">
            {language === 'fr'
              ? 'Prochaines publications de résultats de vos positions'
              : 'Upcoming earnings releases for your holdings'}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-8">
        {isLoading ? (
          ...
          <div className="bg-slate-100 rounded-xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-slate-600">
                {language === 'fr'
                  ? 'Voici les prochaines dates de publication des résultats pour vos actions :'
                  : 'Here is the list of upcoming earnings dates for your selected stocks:'}
              </p>
            </div>
          ...
          <div className="bg-slate-100 rounded-xl p-12 text-center">
            ...
            <p className="text-slate-400">
              {language === 'fr'
                ? 'Ajoutez des transactions pour voir les prochaines dates de résultats.'
                : 'Add transactions to see upcoming earnings dates.'}
            </p>
          </div>
        )}
      </div>
