...
// totals across the whole api_usage history, not just the current document, so
// they belong above the page controls rather than mixed in with per-page output.
