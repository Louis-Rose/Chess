    ...
    <div className="flex min-h-[24rem] flex-1 flex-col px-4 py-4 sm:px-6">
      ...
      {current ? (
        ...
        <div
          ...
          onDragLeave={() => setDragging(false)}
          onDrop={onDrop}
          className={`mt-12 aspect-square overflow-hidden rounded-2xl border transition-colors ${
            dragging
              ? 'border-emerald-500 bg-emerald-500/5'
              : 'border-slate-800 bg-slate-800/30 hover:border-emerald-500 hover:bg-emerald-500/5'
          } ${SECTION_WIDTH}`}
        >
          {loading ? (
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold text-slate-100">Upload PDF</h3>
                <p className="mt-1 font-medium text-slate-300">Drop a PDF here, or click to upload.</p>
