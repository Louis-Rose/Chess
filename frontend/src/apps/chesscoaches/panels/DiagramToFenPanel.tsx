...
import { ImageIcon, Clock, Copy, Check, Loader2, BookOpen, X } from 'lucide-react';
...
function SaveToKnowledgeButton({ diagram, editedFen }: { diagram: DiagramExtract; editedFen: string }) {
  const { t } = useLanguage();
