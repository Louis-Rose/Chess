  ...
  return (
    <CollapsibleSection title={t('chess.dailyVolumeTitle')} defaultExpanded standalone={standalone}>
      {(_fullscreen, sectionTitle) => {
        ...
        const pmSymbol = <span className="inline-flex flex-col items-center leading-[0.5] align-middle text-[9px]"><span>+</span><span>−</span></span>;
...
export type { TimePeriod } from '../components/TimePeriodToggle';
