...
import { Calendar, TrendingUp, Home, Shield, LogOut, Trash2, Clock, Award, Target } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/chess/when-to-play', labelKey: 'chess.navWhenToPlay', icon: Clock },
];
