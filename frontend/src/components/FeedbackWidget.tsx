      ...
      <div className="flex items-center gap-2">
        ...
        {!isOpen && (
          <a
            ...
            className="shadow-lg flex items-center gap-2 px-4 py-3 rounded-full bg-[#0A66C2] hover:bg-[#004182] hover:scale-105 transition-all duration-200"
            title="LinkedIn"
          >
        ...
        <button
          ...
          className={`shadow-lg flex items-center justify-center transition-all duration-200 ${
            isOpen
              ? 'w-12 h-12 rounded-full bg-slate-600 hover:bg-slate-700'
              : 'w-12 h-12 rounded-full bg-green-600 hover:bg-green-700 hover:scale-105'
          }`}
          title={isOpen ? undefined : t.tooltip}
        >
          {isOpen ? (
