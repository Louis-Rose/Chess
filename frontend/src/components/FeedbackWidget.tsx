...
export function FeedbackWidget({ language = 'en', mobileBottom = 'bottom-24' }: FeedbackWidgetProps) {
  ...
  return (
    <div className={`fixed ${mobileBottom} md:bottom-6 right-2 md:right-6 z-50`}>
      ...
      {isOpen ? (
        <button
          onClick={() => setIsOpen(false)}
          className="shadow-lg w-12 h-12 rounded-full bg-slate-600 hover:bg-slate-700 flex items-center justify-center transition-all duration-200"
        >
