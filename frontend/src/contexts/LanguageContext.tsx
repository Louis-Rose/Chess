...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chess.onboardingDescription': 'LUMNA is an AI-powered chess analytics tool which provides insights on how and when you should play to improve faster.',
  ...
  fr: {
    ...
    'chess.onboardingDescription': 'LUMNA est un outil d\'analyse d\'échecs alimenté par l\'IA qui vous indique comment et quand jouer pour progresser plus vite.',
