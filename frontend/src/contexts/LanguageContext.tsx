...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chess.winRateFilter': 'Only game counts with more than 5 days of data are shown.',
    ...
    'chess.keepPlaying': 'Keep playing:',
    'chess.stopPlaying': 'Stop playing:',
    'chess.situation': 'Situation',
    'chess.games': 'games',
    'chess.after1Win': 'After 1 win',
    'chess.after2Wins': 'After 2 wins',
    'chess.after3Wins': 'After 3 wins',
  ...
  fr: {
    ...
    'chess.keepPlaying': 'Continuez à jouer :',
    'chess.stopPlaying': 'Arrêtez de jouer :',
    'chess.situation': 'Situation',
    'chess.games': 'parties',
    'chess.after1Win': 'Après 1 victoire',
    'chess.after2Wins': 'Après 2 victoires',
    'chess.after3Wins': 'Après 3 victoires',
