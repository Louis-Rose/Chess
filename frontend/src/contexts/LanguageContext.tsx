...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.processingDone3': 'To edit a move, drag a piece on the board and then click confirm.',
  ...
  fr: {
    ...
    'coaches.processingDone3': 'Pour corriger un coup, déplacez une pièce sur l\'échiquier puis cliquez sur confirmer.',
