...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.processingDone': 'Processing is complete. There are {count} moves to review. To edit a move, drag a piece on the board and then click confirm.',
  ...
  fr: {
    ...
    'coaches.processingDone': 'Traitement terminé ! Il y a {count} coups à vérifier. Pour corriger un coup, déplacez une pièce sur l\'échiquier puis cliquez sur confirmer.',
