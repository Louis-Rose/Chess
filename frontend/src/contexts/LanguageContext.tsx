...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.uploadExplanation': 'Upload your own scoresheet, or try the feature with a provided sample',
  ...
  fr: {
    ...
    'coaches.uploadExplanation': 'Importez votre propre feuille de partie, ou testez avec un exemple fourni',
