...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.mwrTooltip': 'Also known as IRR (Internal Rate of Return). Measures your actual return including the timing and size of your deposits/withdrawals.',
  ...
  fr: {
    ...
    'performance.mwrTooltip': 'Aussi connu comme TRI (Taux de Rendement Interne). Mesure votre rendement réel en tenant compte du timing et du montant de vos dépôts/retraits.',
