...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.homePrompt': 'Upload a photo of a handwritten scoresheet to convert it to PGN',
  ...
  fr: {
    ...
    'coaches.homePrompt': 'Prenez en photo une feuille de partie manuscrite pour la convertir en PGN',
