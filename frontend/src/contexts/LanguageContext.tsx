...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.srCagrExample': 'Example:\nYear 0: Invest €1,000\nYear 2: Value is €1,210\nSR = +21%\nCAGR = +10%/year',
    'performance.twrMwrExample': 'Example:\nJan: Invest €10,000\nJun: Value €11,000, add €5,000\nDec: Value €17,000\nTWR = +6.3% (investment performance)\nMWR/IRR = +4.5% (your return, affected by deposit timing)',
  ...
  fr: {
    ...
    'performance.srCagrExample': 'Exemple :\nAn 0 : Investir 1 000€\nAn 2 : Valeur 1 210€\nRS = +21%\nTCAC = +10%/an',
    'performance.twrMwrExample': 'Exemple :\nJan : Investir 10 000€\nJuin : Valeur 11 000€, ajouter 5 000€\nDéc : Valeur 17 000€\nRPT = +6.3% (perf. investissement)\nRPA/TRI = +4.5% (votre rendement, affecté par le timing du dépôt)',
