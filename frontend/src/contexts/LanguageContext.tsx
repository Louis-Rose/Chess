...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.srCagrExample': 'You invest €1,000 at the start of Year 0.\nAfter 1 year, you add €5,000.\nAfter 2 years, your portfolio is worth €7,260.\nSimple Return = (7260 - 6000) / 6000 = +21%\nCAGR = (7260 / 1000)^(1/2) - 1 = +169% per year\nNote: CAGR only uses your INITIAL investment (€1,000), ignoring later deposits. This can give misleading high values.',
  ...
  fr: {
    ...
    'performance.srCagrExample': 'Vous investissez 1 000€ au début de l\'année 0.\nAprès 1 an, vous ajoutez 5 000€.\nAprès 2 ans, votre portefeuille vaut 7 260€.\nRendement Simple = (7260 - 6000) / 6000 = +21%\nTCAC = (7260 / 1000)^(1/2) - 1 = +169% par an\nNote : Le TCAC utilise uniquement votre investissement INITIAL (1 000€), ignorant les dépôts ultérieurs. Cela peut donner des valeurs trompeusement élevées.',
