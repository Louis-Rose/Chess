...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.twrMwrExample': 'Example: You invest €10,000. After 6 months it grows to €11,000. You add €5,000. After another 6 months, total is €17,000. TWR = 6.3% (measures investment performance). MWR/IRR = 4.5% (measures your actual return, affected by timing of your €5,000 deposit).',
  ...
  fr: {
    ...
    'performance.twrMwrExample': 'Exemple : Vous investissez 10 000€. Après 6 mois, ça atteint 11 000€. Vous ajoutez 5 000€. Après 6 mois de plus, le total est de 17 000€. TRI = 6.3% (mesure la performance de l\'investissement). TRM = 4.5% (mesure votre rendement réel, affecté par le timing de votre dépôt de 5 000€).',
    'performance.year': 'an',
