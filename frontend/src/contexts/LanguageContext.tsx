...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.students.editStudent': 'Edit Student',
    'coaches.students.deleteStudent': 'Delete Student',
    'coaches.students.deleteConfirm': 'Delete this student and all their lesson history?',
    'coaches.students.name': 'Name',
    'coaches.students.chesscom': 'Chess.com',
    'coaches.students.lichess': 'Lichess',
    'coaches.students.email': 'Email',
    'coaches.students.phone': 'Phone',
    'coaches.students.timezone': 'Timezone',
    'coaches.students.platform': 'Platform',
    'coaches.students.platformLink': 'Meeting link',
    'coaches.students.rate': 'Rate',
    'coaches.students.perLesson': '/lesson',
    'coaches.students.setRate': 'Set rate',
    'coaches.students.notes': 'Notes',
    'coaches.students.minor': 'Under 18',
    'coaches.students.parentName': 'Parent name',
    'coaches.students.parentEmail': 'Parent email',
    'coaches.students.parentPhone': 'Parent phone',
    'coaches.students.paymentStatus': 'Payment',
    'coaches.students.paid': 'Paid',
    'coaches.students.pending': 'Pending',
    'coaches.students.overdue': 'Overdue',
    'coaches.students.bundle': 'Bundle',
    'coaches.students.lessonsRemaining': 'lessons remaining',
    'coaches.students.lessonRemaining': 'lesson remaining',
    'coaches.students.noBundle': 'No bundle',
    'coaches.students.addBundle': 'New bundle',
    'coaches.students.totalLessons': 'Total lessons',
    'coaches.students.bundlePrice': 'Bundle price',
    'coaches.students.lessons': 'Lessons',
    'coaches.students.completed': 'Completed',
    'coaches.students.noShows': 'No-shows',
    'coaches.students.rescheduled': 'Rescheduled',
    'coaches.students.cancelled': 'Cancelled',
    'coaches.students.nextLesson': 'Next lesson',
    'coaches.students.noUpcoming': 'None scheduled',
    'coaches.students.logLesson': 'Log Lesson',
    ...
    'coaches.students.topic': 'Topic',
    'coaches.students.status': 'Status',
    'coaches.students.scheduled': 'Scheduled',
    'coaches.students.completedStatus': 'Completed',
    'coaches.students.cancelledStatus': 'Cancelled',
    'coaches.students.noShow': 'No-show',
    'coaches.students.rescheduledStatus': 'Rescheduled',
    'coaches.students.localTime': 'Local time',
    'coaches.students.yourTime': 'Your time',
    'coaches.students.save': 'Save',
    'coaches.students.cancel': 'Cancel',
    'coaches.students.active': 'Active',
    'coaches.students.archived': 'Archived',
    'coaches.students.archive': 'Archive',
    'coaches.students.restore': 'Restore',
    'coaches.students.allStudents': 'All',
    'coaches.students.ghostAlert': 'No contact',
    'coaches.students.ghostDays': 'days',
    'coaches.students.pingReminder': 'Send reminder',
    'coaches.students.lessonHistory': 'Lesson History',
    'coaches.students.parentContact': 'Parent / Guardian',
    'coaches.students.currency': 'Currency',
    'coaches.students.search': 'Search students...',
    'coaches.students.sortBy': 'Sort by',
    'coaches.students.sortName': 'Name',
    'coaches.students.sortNextLesson': 'Next lesson',
    'coaches.students.sortPayment': 'Payment status',
    'coaches.students.zoom': 'Zoom',
    'coaches.students.googleMeet': 'Google Meet',
    'coaches.students.discord': 'Discord',
    'coaches.students.otb': 'Over the board',
    'coaches.students.bundleLow': 'Bundle running low',
    'coaches.students.viewProfile': 'View profile',
    'coaches.students.expiresAt': 'Expires',
  ...
  fr: {
    ...
    'coaches.students.editStudent': 'Modifier l\'élève',
    'coaches.students.deleteStudent': 'Supprimer l\'élève',
    'coaches.students.deleteConfirm': 'Supprimer cet élève et tout son historique de cours ?',
    'coaches.students.name': 'Nom',
    'coaches.students.chesscom': 'Chess.com',
    'coaches.students.lichess': 'Lichess',
    'coaches.students.email': 'Email',
    'coaches.students.phone': 'Téléphone',
    'coaches.students.timezone': 'Fuseau horaire',
    'coaches.students.platform': 'Plateforme',
    'coaches.students.platformLink': 'Lien de réunion',
    'coaches.students.rate': 'Tarif',
    'coaches.students.perLesson': '/cours',
    'coaches.students.setRate': 'Définir le tarif',
    'coaches.students.notes': 'Notes',
    'coaches.students.minor': 'Moins de 18 ans',
    'coaches.students.parentName': 'Nom du parent',
    'coaches.students.parentEmail': 'Email du parent',
    'coaches.students.parentPhone': 'Téléphone du parent',
    'coaches.students.paymentStatus': 'Paiement',
    'coaches.students.paid': 'Payé',
    'coaches.students.pending': 'En attente',
    'coaches.students.overdue': 'En retard',
    'coaches.students.bundle': 'Forfait',
    'coaches.students.lessonsRemaining': 'cours restants',
    'coaches.students.lessonRemaining': 'cours restant',
    'coaches.students.noBundle': 'Pas de forfait',
    'coaches.students.addBundle': 'Nouveau forfait',
    'coaches.students.totalLessons': 'Nombre de cours',
    'coaches.students.bundlePrice': 'Prix du forfait',
    'coaches.students.lessons': 'Cours',
    'coaches.students.completed': 'Terminés',
    'coaches.students.noShows': 'Absences',
    'coaches.students.rescheduled': 'Reportés',
    'coaches.students.cancelled': 'Annulés',
    'coaches.students.nextLesson': 'Prochain cours',
    'coaches.students.noUpcoming': 'Aucun prévu',
    'coaches.students.logLesson': 'Enregistrer un cours',
    'coaches.students.scheduleLesson': 'Planifier',
    'coaches.students.when': 'Quand',
    'coaches.students.duration': 'Durée',
    'coaches.students.minutes': 'min',
    'coaches.students.topic': 'Sujet',
    'coaches.students.status': 'Statut',
    'coaches.students.scheduled': 'Planifié',
    'coaches.students.completedStatus': 'Terminé',
    'coaches.students.cancelledStatus': 'Annulé',
    'coaches.students.noShow': 'Absent',
    'coaches.students.rescheduledStatus': 'Reporté',
    'coaches.students.localTime': 'Heure locale',
    'coaches.students.yourTime': 'Votre heure',
    'coaches.students.save': 'Enregistrer',
    'coaches.students.cancel': 'Annuler',
    'coaches.students.active': 'Actifs',
    'coaches.students.archived': 'Archivés',
    'coaches.students.archive': 'Archiver',
    'coaches.students.restore': 'Restaurer',
    'coaches.students.allStudents': 'Tous',
    'coaches.students.ghostAlert': 'Sans nouvelles',
    'coaches.students.ghostDays': 'jours',
    'coaches.students.pingReminder': 'Envoyer un rappel',
    'coaches.students.lessonHistory': 'Historique des cours',
    'coaches.students.parentContact': 'Parent / Tuteur',
    'coaches.students.currency': 'Devise',
    'coaches.students.search': 'Rechercher des élèves...',
    'coaches.students.sortBy': 'Trier par',
    'coaches.students.sortName': 'Nom',
    'coaches.students.sortNextLesson': 'Prochain cours',
    'coaches.students.sortPayment': 'Statut de paiement',
    'coaches.students.zoom': 'Zoom',
    'coaches.students.googleMeet': 'Google Meet',
    'coaches.students.discord': 'Discord',
    'coaches.students.otb': 'En présentiel',
    'coaches.students.bundleLow': 'Forfait bientôt épuisé',
    'coaches.students.viewProfile': 'Voir le profil',
    'coaches.students.expiresAt': 'Expire le',
