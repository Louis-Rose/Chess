...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'transactions.searchStocks': 'Search S&P 500 stocks...',
    ...
    'performance.totalReturn': 'Unrealized Gains',
  ...
  fr: {
    ...
    'transactions.searchStocks': 'Rechercher des actions S&P 500...',
    ...
    'performance.totalReturn': 'Plus-value latente',
