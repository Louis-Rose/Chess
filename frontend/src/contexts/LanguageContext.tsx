...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'taxCalc.subtitle': 'Compare Dutch CTO vs French Holding over time',
    ...
    'taxCalc.initialGains': 'Initial unrealized gains (€)',
    'taxCalc.chartTitle': 'Portfolio Value Over Time',
    'taxCalc.tableTitle': 'Year-by-Year Breakdown',
    'taxCalc.yearCol': 'Year',
    'taxCalc.dutchPortfolio': 'Dutch Portfolio',
    'taxCalc.dutchTax': 'Dutch Tax',
    'taxCalc.frenchPortfolio': 'French Portfolio',
    'taxCalc.frenchCosts': 'French Costs',
  ...
  fr: {
    ...
    'taxCalc.subtitle': 'Comparez le CTO néerlandais vs la Holding française dans le temps',
    ...
    'taxCalc.initialGains': 'Plus-values latentes initiales (€)',
    'taxCalc.chartTitle': 'Valeur du portefeuille dans le temps',
    'taxCalc.tableTitle': 'Détail année par année',
    'taxCalc.yearCol': 'Année',
    'taxCalc.dutchPortfolio': 'Portefeuille CTO',
    'taxCalc.dutchTax': 'Impôt CTO',
    'taxCalc.frenchPortfolio': 'Portefeuille Holding',
    'taxCalc.frenchCosts': 'Coûts Holding',
