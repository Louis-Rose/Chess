...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.srCagrExample': 'Example: Year 0: Invest €1,000 · Year 2: Value is €1,210 · SR = +21% · CAGR = +10%/year',
    'performance.twrMwrExample': 'Example: Jan: Invest €10,000 · Jun: Value €11,000, add €5,000 · Dec: Value €17,000 · TWR = +6.3% (investment performance) · MWR/IRR = +4.5% (your return, affected by deposit timing)',
  ...
  fr: {
    ...
    'performance.srCagrExample': 'Exemple : An 0 : Investir 1 000€ · An 2 : Valeur 1 210€ · RS = +21% · TCAC = +10%/an',
    'performance.twrMwrExample': 'Exemple : Jan : Investir 10 000€ · Juin : Valeur 11 000€, ajouter 5 000€ · Déc : Valeur 17 000€ · TRI = +6.3% (perf. investissement) · TRM = +4.5% (votre rendement, affecté par le timing du dépôt)',
