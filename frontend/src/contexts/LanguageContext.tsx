...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'chess.bestGamesDescription': 'Are you better on your 1st, 3rd or 5th game of the day?',
    'chess.streaksCardTitle': 'Streaks',
    'chess.streaksDescription': 'Should you keep playing after a loss?',
  ...
  fr: {
    ...
    'chess.bestGamesDescription': 'Êtes-vous meilleur à votre 1ère, 3ème ou 5ème partie du jour ?',
    'chess.streaksCardTitle': 'Séries',
    'chess.streaksDescription': 'Devriez-vous continuer à jouer après une défaite ?',
