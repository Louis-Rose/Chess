...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'performance.srCagrExample': 'You invest €1,000 at the start of Year 0.\nAfter 2 years, your portfolio is worth €1,210.\nSimple Return = (1210 - 1000) / 1000 = +21%\nCAGR = the annualized version of SR = +10% per year',
    'performance.twrMwrExample': 'In January, you invest €10,000.\nBy June, it has grown to €11,000. You then add €5,000.\nBy December, the total value is €17,000.\nTWR = +6.3% (measures pure investment performance, ignoring your deposits)\nMWR/IRR = +4.5% (measures your actual return, affected by when you deposited)',
  ...
  fr: {
    ...
    'performance.srCagrExample': 'Vous investissez 1 000€ au début de l\'année 0.\nAprès 2 ans, votre portefeuille vaut 1 210€.\nRendement Simple = (1210 - 1000) / 1000 = +21%\nTCAC = la version annualisée du RS = +10% par an',
    'performance.twrMwrExample': 'En janvier, vous investissez 10 000€.\nEn juin, la valeur est de 11 000€. Vous ajoutez alors 5 000€.\nEn décembre, la valeur totale est de 17 000€.\nRPT = +6.3% (mesure la performance pure de l\'investissement, sans tenir compte de vos dépôts)\nRPA/TRI = +4.5% (mesure votre rendement réel, affecté par le moment de vos dépôts)',
