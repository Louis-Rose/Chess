...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.cropHint': 'Crop to the moves area, or confirm to use the full image',
  ...
  fr: {
    ...
    'coaches.cropHint': 'Recadrez sur la zone des coups, ou confirmez pour utiliser l\'image entière',
