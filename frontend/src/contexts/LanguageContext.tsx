...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'coaches.processingDone': 'Processing is complete. Now, verify the highlighted moves. To edit a move, drag a piece on the board and then confirm.',
  ...
  fr: {
    ...
    'coaches.processingDone': 'Traitement terminé. Vérifiez les coups surlignés. Pour corriger un coup, déplacez une pièce sur l\'échiquier puis confirmez.',
