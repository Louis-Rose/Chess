...
def get_video_summary(video_id):
    """Get pre-generated AI summary of a YouTube video.

    Summaries are generated by a local cron job (sync_video_summaries.py)
    ...
    # No cached summary - will be generated by next cron run
