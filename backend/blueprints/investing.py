...
@investing_bp.route('/api/preferences/demo-card-order', methods=['GET'])
...
@investing_bp.route('/api/demo-dashboard', methods=['GET'])
...
@investing_bp.route('/api/investing/transactions/bulk', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/transactions/cleanup-duplicates', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/import/revolut', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/import/credit-mutuel', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/import/interactive-brokers', methods=['POST'])
@login_required
def parse_ibkr_file():
...
@investing_bp.route('/api/investing/import/create-token', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/import/token-info/<token>', methods=['GET'])
...
@investing_bp.route('/api/investing/import/upload/<token>', methods=['POST'])
...
@investing_bp.route('/api/investing/import/status/<token>', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/transactions/<int:transaction_id>', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/investing/transactions/<int:transaction_id>', methods=['PUT'])
@login_required
...
@investing_bp.route('/api/investing/fx-rates', methods=['POST'])
@login_required
def get_fx_rates():
...
@investing_bp.route('/api/investing/holdings', methods=['GET'])
@login_required
def get_holdings():
...
@investing_bp.route('/api/investing/portfolio/composition', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/portfolio/performance-1m', methods=['GET'])
@investing_bp.route('/api/investing/portfolio/performance-period', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/portfolio/top-movers', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/portfolio/stock-performance-3m', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/watchlist/top-movers', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/portfolio/performance', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/watchlist', methods=['GET'])
@login_required
def get_watchlist():
...
@investing_bp.route('/api/investing/watchlist', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/watchlist/<symbol>', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/investing/market-cap', methods=['GET'])
def get_market_cap():
...
@investing_bp.route('/api/investing/stock-history/<ticker>', methods=['GET'])
...
@investing_bp.route('/api/investing/portfolio/financials', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/financials-history/<ticker>', methods=['GET'])
...
@investing_bp.route('/api/investing/banks', methods=['GET'])
def get_banks():
    """Get list of available banks with their fee structures."""
    return jsonify({'banks': BANKS})


@investing_bp.route('/api/investing/account-types', methods=['GET'])
...
@investing_bp.route('/api/investing/accounts/<int:account_id>/duplicate', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/accounts/<int:account_id>/rename', methods=['PUT'])
@login_required
...
@investing_bp.route('/api/investing/accounts/reorder', methods=['PUT'])
@login_required
...
@investing_bp.route('/api/investing/earnings-watchlist', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/earnings-watchlist', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/earnings-watchlist/<symbol>', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/investing/earnings-calendar', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/dividends-calendar', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/dividend-history/<ticker>', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/earnings-alerts', methods=['GET'])
@login_required
...
@investing_bp.route('/api/investing/earnings-alerts', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/earnings-alerts', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/investing/earnings-alerts/send-now', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/news-feed', methods=['GET'])
def get_news_feed():
...
@investing_bp.route('/api/investing/video-summary/<video_id>', methods=['GET'])
...
@investing_bp.route('/api/investing/video-summaries/pending', methods=['GET'])
...
@investing_bp.route('/api/investing/sync/tickers-to-sync', methods=['GET'])
...
@investing_bp.route('/api/investing/sync/clear-video-cache', methods=['POST'])
...
@investing_bp.route('/api/investing/sync/start', methods=['POST'])
def sync_start():
...
@investing_bp.route('/api/investing/sync/update/<int:run_id>', methods=['POST'])
...
@investing_bp.route('/api/investing/sync/end/<int:run_id>', methods=['POST'])
def sync_end(run_id):
...
@investing_bp.route('/api/investing/video-summaries/upload', methods=['POST'])
...
@investing_bp.route('/api/investing/graph-download', methods=['POST'])
@login_required
...
@investing_bp.route('/api/investing/stock-view', methods=['POST'])
@login_required
...
@investing_bp.route('/api/demo/accounts', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/accounts', methods=['POST'])
@login_required
...
@investing_bp.route('/api/demo/accounts/<int:account_id>', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/demo/accounts/<int:account_id>/rename', methods=['PUT'])
@login_required
...
@investing_bp.route('/api/demo/accounts/reorder', methods=['PUT'])
@login_required
...
@investing_bp.route('/api/demo/transactions', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/transactions', methods=['POST'])
@login_required
...
@investing_bp.route('/api/demo/transactions/<int:transaction_id>', methods=['DELETE'])
@login_required
...
@investing_bp.route('/api/demo/holdings', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/portfolio/composition', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/portfolio/performance-period', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/portfolio/top-movers', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/portfolio/financials', methods=['GET'])
@login_required
...
@investing_bp.route('/api/demo/banks', methods=['GET'])
def get_demo_banks():
    """Get available banks."""
    return jsonify({'banks': BANKS})


@investing_bp.route('/api/demo/account-types', methods=['GET'])
...
@investing_bp.route('/api/demo/model-portfolio', methods=['GET'])
...
@investing_bp.route('/api/demo/model-portfolio/performance', methods=['GET'])
...
@investing_bp.route('/api/demo/admin/model-portfolio', methods=['GET'])
@admin_required
...
@investing_bp.route('/api/demo/admin/model-portfolio', methods=['POST'])
@admin_required
...
@investing_bp.route('/api/demo/admin/model-portfolio/<int:stock_id>', methods=['PUT'])
@admin_required
...
@investing_bp.route('/api/demo/admin/model-portfolio/<int:stock_id>', methods=['DELETE'])
@admin_required
...
@investing_bp.route('/api/demo/admin/model-portfolio/reset', methods=['POST'])
@admin_required
